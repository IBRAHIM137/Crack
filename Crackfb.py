...
logo = """\x1b[32;1m╔╦╗┌─┐┬─┐┬┌─   ╔═╗╔╗
 ║║├─┤├┬┘├┴┐───╠╣ ╠╩╗
═╩╝┴ ┴┴└─┴ ┴   ╚  ╚═╝
Author \x1b[00m: MR-XPLOIT404
\x1b[92mGithub \x1b[00m: Github.com/IBRAHIM137
\x1b[92mWhatsApp\x1b[00m : +6287819450610\n\x1b[00m------------------------------------------"""
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('https://www.youtube.com/channel/UCpkpo77N8zfXBr9JUzp8gGg')
                menu()
